                ...
                <div class="col-xl-3 col-md-4 wow fadeInLeft">
                    <div class="wsus__dashboard_sidebar">
                        <div class="wsus__dashboard_sidebar_top">
                            ...
                            <div class="img">
                                <img src="{{ asset('/') }}frontend/assets/images/dashboard_profile_img.png"
                        ...
                        <ul class="wsus__dashboard_sidebar_menu">
                            ...
                            <li>
                                <a href="dashboard_security.html">
                                    <div class="img">
                                        <img src="{{ asset('/') }}frontend/assets/images/dash_icon_10.png"
                            ...
                            <li>
                                <a href="dashboard_social_account.html">
                                    <div class="img">
                                        <img src="{{ asset('/') }}frontend/assets/images/dash_icon_11.png"
                                            alt="icon" class="img-fluid w-100">
                                    </div>
                                    Social Profile
                                </a>
                            ...
                            <li>
                                <a href="dashboard_notification.html">
                                    <div class="img">
                                        <img src="{{ asset('/') }}frontend/assets/images/dash_icon_12.png"
                                            alt="icon" class="img-fluid w-100">
                                    </div>
                                    Notifications
                                </a>
                            ...
                            <li>
                                <a href="dashboard_privacy.html">
                                    <div class="img">
                                        <img src="{{ asset('/') }}frontend/assets/images/dash_icon_13.png"
                                            alt="icon" class="img-fluid w-100">
                                    </div>
                                    Profile Privacy
                                </a>
