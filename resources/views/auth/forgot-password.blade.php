...
<body class="home_3">
    ...
    <section class="wsus__sign_in">
        <div class="row align-items-center">
            <div class="col-xxl-5 col-xl-6 col-lg-6 wow fadeInLeft">
                <div class="wsus__sign_img">
                    <img src="{{ asset('/') }}frontend/assets/images/login_img_1.jpg" alt="login"
                        class="img-fluid">
                    <a href="index.html">
                        ...
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                            ...
                            <form action="{{ route('password.email') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        <div class="wsus__login_form_input">
                                            <button type="submit" class="common_btn">Email Password Reset
                                                Link</button>
                                        </div>
        ...
        <a class="back_btn" href="{{ route('login') }}">Back to Login</a>
    </section>
    <!--===========================
        SIGN IN END
    ============================-->
